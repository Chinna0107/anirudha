        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <img 
              ...
              className={`rounded-xl object-cover shadow border transition-all duration-500 ${isScrolled ? 'w-12 h-12 md:w-10 md:h-10 border-slate-100' : 'w-20 h-20 md:w-16 md:h-16 border-white/20'}`} 
            />
            <div className="flex flex-col">
              ...
              <span className={`text-[10px] md:text-[10px] uppercase tracking-widest font-bold font-sans transition-colors duration-500 ${isScrolled ? 'text-slate-500' : 'text-brand-accent/90'}`}>
